...
* PICO-8 omits a few features of Lua and provides a few extra shortcuts/functions of its own due to its role as a game development software;
* Letters in PICO-8 cannot be capitalised, and spaces/tabs provide the same amount indentation within the IDE, which explains potential oddities in my code's presentation.